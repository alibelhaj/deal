 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\CouponRepository")
 */
class Coupon
{
    /**
    ...
    private $command;
    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\Invoice", inversedBy="coupon")
     * @ORM\JoinColumn(name="invoice_id", referencedColumnName="id",onDelete="CASCADE" ,nullable=true)
     */
    private $invoice;
    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\Booking", mappedBy="coupon")
     */
    private $booking;
    /**
     * contruct
     ...
     * @return Coupon
     */
    public function setCommand(\EntityBundle\Entity\Command $command = null)
    {
     ...
     * @return Coupon
     */
    public function setInvoice(\EntityBundle\Entity\Invoice $invoice = null)
    {
     ...
     * Get invoice
     *
     * @return \EntityBundle\Entity\Invoice 
     */
     ...
     * Add booking
     *
     * @param \EntityBundle\Entity\Booking $booking
     * @return Coupon
     */
    public function addBooking(\EntityBundle\Entity\Booking $booking)
    {
     ...
     * @param \EntityBundle\Entity\Booking $booking
     */
    public function removeBooking(\EntityBundle\Entity\Booking $booking)
    {
