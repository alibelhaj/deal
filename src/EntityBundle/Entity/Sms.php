 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\SmsRepository")
 */
class Sms
{
    /**
     ...
     * Add smstmp
     *
     * @param \EntityBundle\Entity\Smstmp $smstmp
     * @return Sms
     */
    public function addSmstmp(\EntityBundle\Entity\Smstmp $smstmp)
    {
        $this->smstmp[] = $smstmp;
     ...
     * @param \EntityBundle\Entity\Smstmp $smstmp
     */
    public function removeSmstmp(\EntityBundle\Entity\Smstmp $smstmp)
    {
