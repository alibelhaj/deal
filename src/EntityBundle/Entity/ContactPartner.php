 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\ContactPartnerRepository")
 */
class ContactPartner
{
    ...
    private $job;
    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\User", inversedBy="contactpartner")
