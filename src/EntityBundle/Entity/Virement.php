...
class Virement
{
     ...
     * Add remboursement
     *
     * @param \EntityBundle\Entity\Remboursement $remboursement
     * @return Virement
     */
    public function addRemboursement(\EntityBundle\Entity\Remboursement $remboursement)
    {
     ...
     * @param \EntityBundle\Entity\Remboursement $remboursement
     */
    public function removeRemboursement(\EntityBundle\Entity\Remboursement $remboursement)
    {
