 ...
 *
 * @ORM\Table("schedule")
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\ScheduleRepository")
 */
class Schedule
{
    /**
     ...
     * @return Schedule
     */
    public function setSellingpoint(\EntityBundle\Entity\SellingPoint $sellingpoint = null)
    {
     ...
     * Get sellingpoint
     *
     * @return \EntityBundle\Entity\SellingPoint 
     */
