 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\ReferenceRepository")
 */
class Reference {
    ...
    private $annexe;
    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\Command", mappedBy="reference", cascade={"remove"})
     */
    private $command;
