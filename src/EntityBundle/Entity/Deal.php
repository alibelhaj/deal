 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\DealRepository")
 */
class Deal {
    ...
    /**
     * @ORM\OneToOne(targetEntity="EntityBundle\Entity\Planning", inversedBy="deal")
     * @ORM\JoinColumn(name="planning_id", referencedColumnName="id")
     * */
    private $planning;

    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\Command", mappedBy="deal", cascade={"remove"})
     */
    private $command;
    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\Invoice", mappedBy="deal", cascade={"remove"})

     */
    private $invoice;

    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\User", inversedBy="deal")
     ...
     * Add invoice
     *
     * @param \EntityBundle\Entity\Invoice $invoice
     * @return Deal
     */
    public function addInvoice(\EntityBundle\Entity\Invoice $invoice)
    {
     ...
     * @param \EntityBundle\Entity\Invoice $invoice
     */
    public function removeInvoice(\EntityBundle\Entity\Invoice $invoice)
    {
     ...
     * Set redacteur
     *
     * @param \EntityBundle\Entity\User $redacteur
     * @return Deal
     */
    public function setRedacteur(\EntityBundle\Entity\User $redacteur = null)
    {
     ...
     * Add dealhistory
     *
     * @param \EntityBundle\Entity\Dealhistory $dealhistory
     * @return Deal
     */
    public function addDealhistory(\EntityBundle\Entity\Dealhistory $dealhistory)
    {
     ...
     * @param \EntityBundle\Entity\Dealhistory $dealhistory
     */
    public function removeDealhistory(\EntityBundle\Entity\Dealhistory $dealhistory)
    {
