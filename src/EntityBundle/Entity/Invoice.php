 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Entity\InvoiceRepository")
 */
class Invoice
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\Coupon", mappedBy="invoice", cascade={"remove"})
     */
    protected $coupon;


    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\User", inversedBy="Invoice")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\Deal", inversedBy="Invoice")
