 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\CaisseRepository")
 */
class Caisse
{
    /**
    ...
    private $operation;
    /**
     * @ORM\OneToOne(targetEntity="EntityBundle\Entity\User", inversedBy="caisse")
    ...
    */
     ...
     * @return Caisse
     */
    public function addCommande(\EntityBundle\Entity\Command $commande)
    {
     ...
     * @param \EntityBundle\Entity\Command $commande
     */
    public function removeCommande(\EntityBundle\Entity\Command $commande)
    {
