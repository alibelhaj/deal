 ...
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\SellingPointRepository")
 */
class SellingPoint {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\User", inversedBy="sellingpoint")
    ...
    protected $schedule;
    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\Localite", inversedBy="sellingpoint")
     ...
     * Add schedule
     *
     * @param \EntityBundle\Entity\Schedule $schedule
     * @return SellingPoint
     */
    public function addSchedule(\EntityBundle\Entity\Schedule $schedule)
    {
     ...
     * @param \EntityBundle\Entity\Schedule $schedule
     */
    public function removeSchedule(\EntityBundle\Entity\Schedule $schedule)
    {
