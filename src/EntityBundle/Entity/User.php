...
class User extends BaseUser
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\Bank", inversedBy="user")
    ...
    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\ContactPartner", mappedBy="user", cascade={"remove"})
     */
    protected $contactpartner;

    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\Protocol", mappedBy="user", cascade={"remove"})
     */
    protected $protocol;
    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\SellingPoint", mappedBy="user", cascade={"remove"})
     */
    protected $sellingpoint;
    /**
     * @ORM\ManyToMany(targetEntity="EntityBundle\Entity\Region", inversedBy="user")
     * @ORM\JoinTable(name="region_partner")
     * */
    protected $region;
    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\Command", mappedBy="user", cascade={"remove"})
     */
    private $command;
    /**
     * @ORM\OneToOne(targetEntity="EntityBundle\Entity\Caisse", mappedBy="user", cascade={"remove"})
     */
    private $caisse;

    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\Category", inversedBy="user")
     * @ORM\JoinColumn(name="category_id", referencedColumnName="id")
     * */
    protected $category;

    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\Operation", mappedBy="user", cascade={"remove"})
     */
    private $operation;
    /**
     * @var \DateTime
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\Localite", inversedBy="user")
     ...
     * Set bank
     *
     * @param \EntityBundle\Entity\Bank $bank
     * @return User
     */
    public function setBank(\EntityBundle\Entity\Bank $bank = null)
    {
        $this->bank = $bank;
     ...
     * Get bank
     *
     * @return \EntityBundle\Entity\Bank
     */
     ...
     * Add contactpartner
     *
     * @param \EntityBundle\Entity\ContactPartner $contactpartner
     * @return User
     */
    public function addContactpartner(\EntityBundle\Entity\ContactPartner $contactpartner)
    {
     ...
     * @param \EntityBundle\Entity\ContactPartner $contactpartner
     */
    public function removeContactpartner(\EntityBundle\Entity\ContactPartner $contactpartner)
    {
     ...
     * Add protocol
     *
     * @param \EntityBundle\Entity\Protocol $protocol
     * @return User
     */
    public function addProtocol(\EntityBundle\Entity\Protocol $protocol)
    {
     ...
     * @param \EntityBundle\Entity\Protocol $protocol
     */
    public function removeProtocol(\EntityBundle\Entity\Protocol $protocol)
    {
     ...
     * Add sellingpoint
     *
     * @param \EntityBundle\Entity\SellingPoint $sellingpoint
     * @return User
     */
    public function addSellingpoint(\EntityBundle\Entity\SellingPoint $sellingpoint)
    {
     ...
     * @param \EntityBundle\Entity\SellingPoint $sellingpoint
     */
    public function removeSellingpoint(\EntityBundle\Entity\SellingPoint $sellingpoint)
    {
     ...
     * Add region
     *
     * @param \EntityBundle\Entity\Region $region
     * @return User
     */
    public function addRegion(\EntityBundle\Entity\Region $region)
    {
        $this->region[] = $region;
     ...
     * @param \EntityBundle\Entity\Region $region
     */
    public function removeRegion(\EntityBundle\Entity\Region $region)
    {
     ...
     * Add command
     *
     * @param \EntityBundle\Entity\Command $command
     * @return User
     */
    public function addCommand(\EntityBundle\Entity\Command $command)
    {
     ...
     * @param \EntityBundle\Entity\Command $command
     */
    public function removeCommand(\EntityBundle\Entity\Command $command)
    {
     ...
     * @return User
     */
    public function addDeal(\EntityBundle\Entity\Deal $deal)
    {
        $this->deal[] = $deal;
     ...
     * @param \EntityBundle\Entity\Deal $deal
     */
    public function removeDeal(\EntityBundle\Entity\Deal $deal)
    {
     ...
     * Set localite
     *
     * @param \EntityBundle\Entity\Localite $localite
     * @return User
     */
    public function setLocalite(\EntityBundle\Entity\Localite $localite = null)
    {
     ...
     * Get localite
     *
     * @return \EntityBundle\Entity\Localite
     */
