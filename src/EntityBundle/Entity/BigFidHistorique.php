 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\BigFidHistoriqueRepository")
 */
class BigFidHistorique
{
    ...
    private $motif;
    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\Client", inversedBy="bigfidhistorique")
     ...
     * Set parent
     *
     * @param \EntityBundle\Entity\BigFidHistorique $parent
     * @return BigFidHistorique
     */
    public function setParent(\EntityBundle\Entity\BigFidHistorique $parent = null)
    {
        $this->parent = $parent;
