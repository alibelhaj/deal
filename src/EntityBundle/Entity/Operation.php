 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\OperationRepository")
 */
class Operation
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EntityBundle\Entity\User", inversedBy="operation")
     ...
     * Set modepayement
     *
     * @param \EntityBundle\Entity\PaymentMethod $modepayement
     * @return Operation
     */
    public function setModepayement(\EntityBundle\Entity\PaymentMethod $modepayement = null)
    {
     ...
     * Get modepayement
     *
     * @return \EntityBundle\Entity\PaymentMethod 
     */
     ...
     * Set caisse
     *
     * @param \EntityBundle\Entity\User $caisse
     * @return Operation
     */
    public function setCaisse(\EntityBundle\Entity\User $caisse = null)
    {
        $this->caisse = $caisse;
     ...
     * Set daf
     *
     * @param \EntityBundle\Entity\User $daf
     * @return Operation
     */
    public function setDaf(\EntityBundle\Entity\User $daf = null)
    {
        $this->daf = $daf;
