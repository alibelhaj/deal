 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\AnnexeRepository")
 */
class Annexe
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\EntityBundle\Entity\Planning", inversedBy="annexe")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\EntityBundle\Entity\User", inversedBy="annexe")
     * @ORM\JoinColumn(name="agent_id", referencedColumnName="id")
     */
    private $agent;
    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\ResponseRequiredInfo", mappedBy="annexe")
     */
     ...
     * @return Annexe
     */
    public function setProtocol(\EntityBundle\Entity\Protocol $protocol = null)
    {
     ...
     * Get protocol
     *
     * @return \EntityBundle\Entity\Protocol
     */
     ...
     * @return Annexe
     */
    public function addReference(\EntityBundle\Entity\Reference $reference)
    {
     ...
     * @param \EntityBundle\Entity\Reference $reference
     */
    public function removeReference(\EntityBundle\Entity\Reference $reference)
    {
