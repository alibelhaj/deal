 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="EntityBundle\Repository\ClientRepository")
 */
class Client implements AdvancedUserInterface
{
    ...
    private $command;
    /**
     * @ORM\OneToMany(targetEntity="EntityBundle\Entity\BigFidHistorique", mappedBy="client", cascade={"remove"})
     */
     ...
     * Add adresses
     *
     * @param \EntityBundle\Entity\Adress $adresses
     * @return Client
     */
    public function addAdress(\EntityBundle\Entity\Adress $adresses)
    {
     ...
     * @param \EntityBundle\Entity\Adress $adresses
     */
    public function removeAdress(\EntityBundle\Entity\Adress $adresses)
    {
     ...
     *
     * @param \EntityBundle\Entity\BigFidHistorique $bigfidhistorique
     * @return Client
     */
    public function addBigfidhistorique(\EntityBundle\Entity\BigFidHistorique $bigfidhistorique)
    {
     ...
     * @param \EntityBundle\Entity\BigFidHistorique $bigfidhistorique
     */
    public function removeBigfidhistorique(\EntityBundle\Entity\BigFidHistorique $bigfidhistorique)
    {
